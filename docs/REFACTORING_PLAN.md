...
> Статус на 28 августа 2026 года: этапы characterization tests, типизации границы, централизованной загрузки, domain-расчетов, facade и удаления `@ts-nocheck` из актуальной страницы выполнены. Данные 2025–26 совпадают с golden-файлами. Остаются конфигурация правил замен, разбиение сезонных файлов, error view и дополнительные unit/UI-тесты.
