...
> Статус на 28 августа 2026 года: этапы characterization tests, типизации границы, централизованной загрузки, domain-расчетов, facade, конфигурации сезонных правил, удаления `@ts-nocheck`, error view и устранения дублирования `matches`/`schedule` выполнены. Данные 2025–26 совпадают с golden-файлами. Остаются разбиение сезонных файлов и дополнительные unit/UI-тесты.
