...
> Статус на 28 августа 2026 года: этапы characterization tests, типизации актуального API/domain/UI-контура, централизованной загрузки, facade, конфигурации сезонных правил, удаления `@ts-nocheck`, error view, устранения дублирования календаря, разбиения сезонных файлов и удаления сезонно-зависимых UI-путей выполнены. Данные 2025–26 совпадают с golden-файлами. Остаются дополнительные unit/UI-тесты.
