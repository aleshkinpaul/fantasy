...
> Статус на 28 августа 2026 года: основной рефакторинг актуального контура выполнен, данные 2025–26 совпадают с golden-файлами. Следующий запуск начинается с усиления валидатора сезонной конфигурации, после чего подключается только Ла Лига 2026–27. ЛЧ отложена и позднее будет подключаться двумя внешними турнирами: общий этап и отдельный плей-офф.
